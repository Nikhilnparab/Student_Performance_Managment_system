                    	...
                    	<ul class="dropdown-menu multi-level">
                         	...
                         	<li class="dropdown-submenu">
                            	...
                            	<ul class="dropdown-menu">
                                	<li><a href="../passed/passedstudent.php">Overall</a></li>
                                	<li><a href="../passed/psessional.php">Sessional</a></li>
									<li><a href="../passed/ptheory.php">Theory</a></li>
									<li><a href="../passed/ppractical.php">Practical</a></li>
                            	</ul>
                        	</li>
                        	...
                        	<li class="divider"></li>
                         	<li class="dropdown-submenu">
                            	...
                            	<ul class="dropdown-menu">
                                	<li><a href="failedstudent.php">Overall</a></li>
                                	<li><a href="fsessional.php">Sessional</a></li>
									<li><a href="#">Theory</a></li>
									<li><a href="fpractical.php">Practical</a></li>
                            	</ul>
                        	</li>
...
<div class="container">    
  <h2><b>Marks of failed students in theory</b></h2>
    ...
    <tbody>
      <tr>
		...
		while($row1=mysqli_fetch_assoc($res1))
		{
			...
			echo "<td><b><i>".$row4["TheoryMarks"]."</b></i></td>";
