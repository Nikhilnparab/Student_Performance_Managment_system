...
$temp1="SELECT * FROM `practical` ORDER BY `practicalmarks` DESC";
...
<div class="container">    
  <h2><b>Marks of students sort by Practical(DESC)</b></h2>
    ...
    <tbody>
      <tr>
		...
		while($row1=mysqli_fetch_assoc($res1))
		{
			...
			$temp4="SELECT * FROM `theory` WHERE `rollNo`=".$x;
			...
			echo "<td>".$row1["practicalmarks"]."</td>";
			...
			echo "<td>".$row1["practicalgrace"]."</td>";
			
			$ses3=$ses2+$row1["practicalmarks"];
			echo "<td>".$ses3."</td>";
