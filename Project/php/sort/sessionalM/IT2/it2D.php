...
$temp1="SELECT * FROM `sessionalm` ORDER BY `IT2` DESC";
                ...
                <li>
                    ...
                    <ul class="dropdown-menu multi-level">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="it2A.php">ASC</a></li>
                                <li><a href="#">DSC</a></li>
                            </ul>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">IA by</a>
                            <ul class="dropdown-menu">
                                <li><a href="../IA/iaA.php">ASC</a></li>
                                <li><a href="../IA/iaD.php">DESC</a></li>
                            </ul>
                        </li>
...
<div class="container">    
  <h2><b>Marks of students sort by IT2(DESC)</b></h2>
