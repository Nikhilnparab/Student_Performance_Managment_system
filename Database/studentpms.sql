    ...
    <div id="pma_console">
        ...
        <div class="content">
            <div class="console_message_container">
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        ...
                        targetdb="studentpms" targettable="">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        targetdb="studentpms" targettable="student">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `student` </span>
                                        ...
                                        <div class="message history collapsed hide "
                        targetdb="studentpms" targettable="counts">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> CREATE TABLE `studentpms`.`counts` ( `fcount` INT NOT NULL ,  `pcount` INT NOT NULL ,  `psessional` INT NOT NULL ,  `ptheory` INT NOT NULL ,  `ppractical` INT NOT NULL ,  `fsessional` INT NOT NULL ,  `ftheory` INT NOT NULL ,  `fpractical` INT NOT NULL ) ENGINE = InnoDB; </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="studentpms" targettable="counts">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> INSERT INTO `counts` (`fcount`, `pcount`, `psessional`, `ptheory`, `ppractical`, `fsessional`, `ftheory`, `fpractical`) VALUES ('0', '0', '0', '0', '0', '0', '0', '0'); </span>
                    </div>
                                        <div class="message history collapsed hide "
                        targetdb="studentpms" targettable="filter">
                        <div class="action_content">
            <span class="action collapse">
            Collapse                    </span>
            <span class="action expand">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> CREATE TABLE `studentpms`.`filter` ( `IT1` INT NOT NULL ,  `IT2` INT NOT NULL ,  `IA` INT NOT NULL ,  `Practical` INT NOT NULL ,  `Theory` INT NOT NULL ,  `Name` VARCHAR(40) NOT NULL ,  `RollNo` INT NOT NULL ,  `practGrace` INT NOT NULL ,  `theoryGrace` INT NOT NULL ) ENGINE = InnoDB; </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="studentpms" targettable="counts">
                        <div class="action_content">
            ...
            Queried time                            : <span> During current session </span>
                        ...
                        <span class="query"> SELECT * FROM `counts` </span>
                    </div>
                                        <div class="message history collapsed hide select"
                        targetdb="studentpms" targettable="counts">
                        <div class="action_content">
