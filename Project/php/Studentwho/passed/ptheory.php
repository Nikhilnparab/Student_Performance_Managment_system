                    	...
                    	<ul class="dropdown-menu multi-level">
                         	...
                         	<li class="dropdown-submenu">
                            	...
                            	<ul class="dropdown-menu">
                                	<li><a href="ptheory.php">Overall</a></li>
                                	<li><a href="psessional.php">Sessional</a></li>
...
<div class="container">    
  <h2><b>Marks of Passed students in Theory</b></h2>
    ...
    <tbody>
      <tr>
		...
		while($row1=mysqli_fetch_assoc($res1))
		{
			...
			echo "<td><i><b>".$row4["TheoryMarks"]."</b></i></td>";
