...
$temp1="SELECT * FROM `sessionalm` ORDER BY `Assignment` DESC";
                    ...
                    <ul class="dropdown-menu multi-level">
                        <li><a href="#">SESSIONAL MARKS</a></li>
                         <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../IT1/it1A.php">ASC</a></li>
                                <li><a href="../IT1/it1D.php">DESC</a></li>
                            </ul>
						</li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">IT 2 by</a>
                            <ul class="dropdown-menu">
                                <li><a href="../IT2/it2A.php">ASC</a></li>
                                <li><a href="../IT2/it2D.php">DESC</a></li>
                            </ul>
						</li>
                        <li class="dropdown-submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">IA by</a>
                            <ul class="dropdown-menu">
                                <li><a href="iaA.php">ASC</a></li>
                                <li><a href="#">DESC</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="divider"></li>
                         <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../../theory/thA.php">ACS</a></li>
                                <li><a href="../../theory/thD.php">DESC</a></li>
                            </ul>
                        </li>
...
<div class="container">    
  <h2><b>Marks of students sort by Internal Assesment(DESC)</b></h2>
    ...
    <tbody>
      <tr>
		...
		while($row1=mysqli_fetch_assoc($res1))
		{
			...
			$temp3="SELECT * FROM `theory` WHERE `rollNo`=".$x;
			...
			echo "<td>".$row1["IT1"]."</td>";
			echo "<td>".$row1["IT2"]."</td>";
			$ses=$row1['Assignment']+(($row1['IT1']+$row1['IT2'])/2);
			echo "<td>".$ses."</td>";
			
			echo "<td>".$row3["TheoryMarks"]."</td>";
			echo "<td>".$row3["GraceMarks"]."</td>";
			$ses2=$row3["TheoryMarks"]+$ses;
			echo "<td>".$ses2."</td>";
			...
			echo "<td>".$ses3."</td>";
			 ...
			 if(($row1['Assignment']+(($row1['IT1']+$row1['IT2'])/2)+$row3["TheoryMarks"])>=50)
			 {
				 echo "<td> PASSES </td>";
			 }
			 else
